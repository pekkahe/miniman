// Alteration for Visual C++ by Pekka Hellsten: 
// Disable "badly-formatted XML comment" warnings for this header file
// since the comments don't follow Microsoft's XML documentation notation.
#pragma warning(push)
